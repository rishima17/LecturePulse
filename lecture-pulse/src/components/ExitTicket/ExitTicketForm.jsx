...
export default function ExitTicketForm({ exitTicket, sessionCode, onComplete }) {
  ...
  const handleTextChange = e => {
      ...
      if (value.length <= MAX_SHORT_ANSWER_LENGTH) {
          ...
          setTextValue(value.slice(0, MAX_SHORT_ANSWER_LENGTH))
      }
  }
  ...
  const handleSubmit = async (e) => {
    ...
    if (exitTicket.type === EXIT_TICKET_TYPES.MULTIPLE_CHOICE) {
        ...
        if (trimmed.length > MAX_SHORT_ANSWER_LENGTH) {
            toast.error(
                `Answer must be ${MAX_SHORT_ANSWER_LENGTH} characters or fewer.`
            )
            return
        }
        submissionValue = trimmed;
    }
              ...
              {!submitted ? (
                  ...
                  >
                      ...
                      <CardHeader className="text-center pb-2 pt-8">
                          ...
                          <CardDescription className="text-sm md:text-base text-muted-foreground mt-1.5">
                              Let your teacher know how you did in today's
                              class. Completely anonymous.
                          </CardDescription>
                      </CardHeader>
                      ...
                      <CardContent className="p-6 md:p-8 space-y-6">
                          ...
                          <form onSubmit={handleSubmit} className="space-y-6">
                              {exitTicket.type ===
                                  EXIT_TICKET_TYPES.MULTIPLE_CHOICE && (
                              ...
                              {exitTicket.type ===
                                  EXIT_TICKET_TYPES.SHORT_ANSWER && (
                  ...
                  >
                      ...
                      <p className="text-muted-foreground text-sm md:text-base max-w-xs mx-auto mb-8">
                          Your response is saved anonymously. Thank you for
                          participating.
                      </p>
